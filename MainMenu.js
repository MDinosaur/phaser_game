export default class MainMenu extends Phaser.Scene {
    ...
    create() {
        const TitleBG = this.add.image(780, 400, 'TitleBG').setScale(0.6);
            console.log(`TitleBG: x=${TitleBG.x}, y=${TitleBG.y}`);
        const DinoFishing = this.add.image(780, 350, 'DinoFishing').setScale(0.6).setInteractive();
        ...
        const playButton = this.add.image(780, 365, 'Play').setScale(0.6).setInteractive();
